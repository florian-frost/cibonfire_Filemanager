...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Upload.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Upload.Reports.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Upload.Reports.Edit');
		...
		{
			$this->auth->restrict('Upload.Reports.Delete');
