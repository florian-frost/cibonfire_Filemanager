...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Upload.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Upload.Settings.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Upload.Settings.Edit');
		...
		{
			$this->auth->restrict('Upload.Settings.Delete');
