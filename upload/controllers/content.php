...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Upload.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Upload.Content.Create');
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Upload.Content.Edit');
		...
		{
			$this->auth->restrict('Upload.Content.Delete');
