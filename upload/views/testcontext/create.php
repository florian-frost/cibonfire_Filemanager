...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Upload" />
            or <?php echo anchor(SITE_AREA .'/testcontext/upload', lang('upload_cancel'), 'class="btn btn-warning"'); ?>
